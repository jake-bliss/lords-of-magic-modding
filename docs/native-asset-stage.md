...
- all 365 loose `.scn`/`.smp`/`.lgd` files pass — 365 of the 366 files in `English/map/`, the exception being `e3map2.map`; all 365 resolve to one of six record layouts and decode 21,117 bounded records;
