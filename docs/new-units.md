...
sheet. Observed in gameplay 2026-09-21. (That the size test reads `currentarmy` while the type lookups
read the *displayed* army is still **Unknown** — the run is consistent with them being the same
army but cannot show that they must be.) Full trail and the code in
