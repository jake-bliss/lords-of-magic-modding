...
- [x] Decode the remaining map-tail variants. **Done 2026-09-17, offline:** there are six record layouts (47, 48, 49, 52 and 53 bytes, two of them with a footer), all 365 installed maps decode, 21,117 records rebuild from typed fields, and object editing works on all 365 rather than 196. The "18 unmatched tails" were nine files of each new size, not a separate phenomenon.
