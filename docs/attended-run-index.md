...
| **D2** the two declared caps | ✅ **DONE 2026-09-21** — `maxauratypes` raised to 100 and two auras registered at **70/71**; a unit type at **199** placed and drew; one definition past capacity refused cleanly with index **-1** and no crash. Took three attempts, both failures mine ([run sheet](unit-cap-run-sheet.md)) |
